...
import com.svail.grid50.util.Comparation;
import com.svail.grid50.util.NiMatrix;
...
import static com.svail.grid50.util.RowColCalculation.codeMapping50toN50;

/**
 * Created by ZhouXiang on 2017/5/9.
 *
...
public class PBSHADE_Spatial_5 extends NiMatrix {
    /**参数说明：
    ...
    public static void main(String[] args){
        ...
        getInterpolationResult(path,23,1,0.8);
    ...
    public static void getInterpolationResult(String path,int months,int datesnum,double R){
        ...
        step_1("InvestmentEvolution","GridData_Resold");
        ...
        String[] dates={"2015-7","2015-8","2015-9","2015-10","2015-11","2015-12","2016-1","2016-2","2016-3",
                "2016-4","2016-5","2016-6","2016-7","2016-8","2016-9","2016-10","2016-11","2016-12",
    ...
    public static JSONObject findRelatedCode(JSONArray lackvalue_grids,int months,double R){
        ...
        for(int i=0;i<lackvalue_grids.size();i++){
            ...
            //加入list之前先根据相关性进行排序
            Collections.sort(rlist, new Comparation.RComparator());
