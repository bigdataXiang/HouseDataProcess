...
public class T3 {
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String sourcepath="D:\\1_paper\\Investment model\\1-有效栅格\\201610\\";
        String storepath="D:\\1_paper\\Investment model\\3-栅格的主要户型\\201610\\";
        DBCollection coll= db.getDB("paper").getCollection("GridData_Resold_gd");
        for(int i=1;i<=21;i++){
            try{
                findHouseType(sourcepath+"等值线_"+i+".txt",storepath+"等值线_"+i+".txt",coll,"2016","10");
